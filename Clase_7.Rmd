...
p<-ggplot()+geom_line(data=datos,aes(x=X_1,y=X_2,group=Tipo,color=Tipo))+geom_line(data=datos_gomery,aes(x=X_1,y=X_2,group=Tipo,color=Tipo),linetype="dotted",alpha=0.5)+scale_color_manual(values=c("#e41a1c", "#377eb8","#4daf4a","#984ea3","#ff7f00","#a65628","#000000","#000000"))+geom_point(data=puntos,aes(x=X1,y=X2),colour = "blue", size = 1,alpha=0.5)
